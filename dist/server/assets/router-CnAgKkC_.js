...
import { T as TSS_SERVER_FUNCTION, g as getServerFnById, c as createServerFn } from "./server-DxzLTJPN.js";
import { r as requireApproved } from "./middleware-DS1paCMp.js";
import { Toaster as Toaster$1 } from "sonner";
const appCss = "/assets/styles-RLXPqH0u.css";
...
function AuthProvider({ children }) {
  ...
  const signUpEmail = async (email, password, fullName, extra, photoFile) => {
    ...
    if (extra) {
      try {
        const { updateMyProfile } = await import("./profile-nNd9QEk1.js");
    ...
    if (photoFile) {
      try {
        const { uploadProfilePhoto } = await import("./profile-nNd9QEk1.js");
...
const $$splitComponentImporter$h = () => import("./auth-hbKlom2t.js");
...
const $$splitComponentImporter$g = () => import("./about-D0UJLyX3.js");
...
const $$splitComponentImporter$f = () => import("./_authenticated-B4awcA0T.js");
const Route$f = createFileRoute("/_authenticated")({
  component: lazyRouteComponent($$splitComponentImporter$f, "component")
});
const $$splitComponentImporter$e = () => import("./index-C1BHMQ-5.js");
...
const $$splitComponentImporter$d = () => import("./support-31wAHLpE.js");
const Route$d = createFileRoute("/_authenticated/support")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$c = () => import("./profile-DfUl2lfO.js");
...
const $$splitComponentImporter$b = () => import("./pending-approval-CYTLUnHU.js");
const Route$b = createFileRoute("/_authenticated/pending-approval")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$a = () => import("./memories-BQw___pf.js");
const Route$a = createFileRoute("/_authenticated/memories")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$9 = () => import("./home-G0MmP8mu.js");
const Route$9 = createFileRoute("/_authenticated/home")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$8 = () => import("./gallery-DnNK54LC.js");
const Route$8 = createFileRoute("/_authenticated/gallery")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$7 = () => import("./events-DTRB1H3u.js");
const Route$7 = createFileRoute("/_authenticated/events")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$6 = () => import("./donations-B3frN6G9.js");
const Route$6 = createFileRoute("/_authenticated/donations")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$5 = () => import("./directory-CzoXmqve.js");
const Route$5 = createFileRoute("/_authenticated/directory")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$4 = () => import("./blogs-_htmmRPd.js");
const Route$4 = createFileRoute("/_authenticated/blogs")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$3 = () => import("./announcements-DFOUe9UH.js");
const Route$3 = createFileRoute("/_authenticated/announcements")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$2 = () => import("./admin-D3MvJVTD.js");
...
const $$splitComponentImporter$1 = () => import("./members._slug-C2bTW45A.js");
const Route$1 = createFileRoute("/_authenticated/members/$slug")({
  head: () => ({
    meta: [{
      title: "Member Blog — SIMCOSA 84–85"
    }]
  }),
...
const $$splitComponentImporter = () => import("./blogs._id-CHey9f7k.js");
...
const AuthenticatedSupportRoute = Route$d.update({
  id: "/support",
  path: "/support",
...
const AuthenticatedPendingApprovalRoute = Route$b.update({
  id: "/pending-approval",
  path: "/pending-approval",
  getParentRoute: () => AuthenticatedRoute
});
const AuthenticatedMemoriesRoute = Route$a.update({
  id: "/memories",
  path: "/memories",
  getParentRoute: () => AuthenticatedRoute
});
const AuthenticatedHomeRoute = Route$9.update({
  id: "/home",
  path: "/home",
  getParentRoute: () => AuthenticatedRoute
});
const AuthenticatedGalleryRoute = Route$8.update({
  id: "/gallery",
  path: "/gallery",
  getParentRoute: () => AuthenticatedRoute
});
const AuthenticatedEventsRoute = Route$7.update({
  id: "/events",
  path: "/events",
  getParentRoute: () => AuthenticatedRoute
});
const AuthenticatedDonationsRoute = Route$6.update({
  id: "/donations",
  path: "/donations",
  getParentRoute: () => AuthenticatedRoute
});
const AuthenticatedDirectoryRoute = Route$5.update({
  id: "/directory",
  path: "/directory",
  getParentRoute: () => AuthenticatedRoute
});
const AuthenticatedBlogsRoute = Route$4.update({
  id: "/blogs",
  path: "/blogs",
  getParentRoute: () => AuthenticatedRoute
});
const AuthenticatedAnnouncementsRoute = Route$3.update({
  id: "/announcements",
  path: "/announcements",
  getParentRoute: () => AuthenticatedRoute
});
...
const AuthenticatedMembersSlugRoute = Route$1.update({
  id: "/members/$slug",
  path: "/members/$slug",
  getParentRoute: () => AuthenticatedRoute
});
...
export {
  Button as B,
  CATEGORIES as C,
  MEMBER_QUOTA_BYTES as M,
  OnlineMembersWidget as O,
  Route$1 as R,
  SAMPLE_BLOGS as S,
  VIDEO_MAX_BYTES as V,
  cn as a,
  Route as b,
  createSsrRpc as c,
  getFirebaseApp as g,

...
const listDonations = createServerFn({
  method: "GET"
}).middleware([requireAuth]).handler(createSsrRpc("bd2839912c2000330c0c97aecda6fa233bd9307559fa681d80581a21face4d1a"));
const listExpenses = createServerFn({
  method: "GET"
}).middleware([requireAuth]).handler(createSsrRpc("d637ebf3b8dc0235d054a0d54d2dfda9e06880542cae18e88788262cd25d7a8d"));
function Donations() {
  const {
    data: donations
  } = useQuery({

...
import { c as createSsrRpc } from "./createSsrRpc-yizNlgol.js";
import { r as requireAuth } from "./middleware-B8Bg16sx.js";
import { c as createServerFn } from "./server-DLN91ng3.js";
import { u as useAuth, B as Button } from "./router-CpAwBtLZ.js";
import { I as Input } from "./input-BuwH3o0Y.js";
import { L as Label } from "./label-hvHDrB7Y.js";
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gradient-to-b from-amber-50/60 to-white", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-6xl px-4 sm:px-6 py-8", children: [
      ...
      items?.length === 0 && /* @__PURE__ */ jsxs("div", { children: [
        ...
        }].map((img) => /* @__PURE__ */ jsxs("div", { className: "rounded-2xl overflow-hidden shadow-sm border border-amber-100 hover:shadow-md transition-shadow group", children: [
      ...
      images.length > 0 && /* @__PURE__ */ jsxs("div", { className: "mb-10", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4", children: images.map((it) => /* @__PURE__ */ jsx(GalleryItem, { item: it }, it.id)) })
      ] }),
...
function GalleryItem({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "rounded-2xl overflow-hidden shadow-sm border border-amber-100 hover:shadow-md transition-shadow group", children: [
    /* @__PURE__ */ jsx("div", { className: `${item.media_type === "video" ? "aspect-video" : "aspect-square"} bg-amber-50 flex items-center justify-center`, children: item.media_type === "video" ? /* @__PURE__ */ jsx("video", { src: url, controls: true, className: "w-full h-full object-cover" }) : /* @__PURE__ */ jsx("img", { src: url, alt: item.caption ?? "Photo", className: "w-full h-full object-cover group-hover:scale-105 transition-transform duration-300", loading: "lazy" }) }),

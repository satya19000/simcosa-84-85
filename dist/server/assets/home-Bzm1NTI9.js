...
import { u as useAuth, B as Button, O as OnlineMembersWidget } from "./router-CxW41eXB.js";
import { useState } from "react";
import { useQueryClient, useQuery } from "@tanstack/react-query";
import { formatDistanceToNow } from "date-fns";
import { toast } from "sonner";
import { l as listMemories, t as toggleLike } from "./memories-BqrLI_lw.js";
...
function Home() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "overflow-x-hidden", children: [
    ...
    /* @__PURE__ */ jsx("section", { className: "py-20 px-4 bg-gradient-to-b from-amber-50/60 to-white", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-6xl", children: [
      /* @__PURE__ */ jsx("div", { className: "mb-10 max-w-sm", children: /* @__PURE__ */ jsx(OnlineMembersWidget, {}) }),

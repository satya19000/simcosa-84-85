...
import { c as createSsrRpc, u as useAuth, B as Button } from "./router-ByRAmPMo.js";
    ...
    /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-5xl px-4 sm:px-6 py-10 space-y-14", children: [
      /* @__PURE__ */ jsxs("section", { children: [
        ...
        upcoming.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "text-center py-12 rounded-2xl border border-amber-100 bg-white", children: [
          ...
          return /* @__PURE__ */ jsxs("article", { className: `bg-white rounded-2xl border shadow-sm overflow-hidden ${isNext ? "border-amber-400 shadow-amber-100" : "border-amber-100"}`, children: [
            ...
            e.cover_url && /* @__PURE__ */ jsx("div", { className: "w-full h-52 overflow-hidden", children: /* @__PURE__ */ jsx("img", { src: e.cover_url, alt: e.title, className: "w-full h-full object-cover", loading: "lazy" }) }),
            /* @__PURE__ */ jsxs("div", { className: "p-6", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "mt-5 flex flex-wrap gap-2 items-center", children: [
                e.rsvp_enabled && RSVP_OPTIONS.map(({
                  ...
                  icon: Icon,
                  active
                }) => /* @__PURE__ */ jsxs(Button, { onClick: () => doRsvp(e.id, value), className: `h-10 px-4 rounded-xl font-semibold text-sm flex items-center gap-2 transition-all ${my === value ? active : "bg-white border border-gray-200 text-gray-600 hover:border-amber-400 hover:text-amber-700"}`, children: [
                ...
                e.external_link && /* @__PURE__ */ jsx("a", { href: e.external_link, target: "_blank", rel: "noopener noreferrer", children: /* @__PURE__ */ jsxs(Button, { variant: "outline", className: "h-10 px-4 rounded-xl flex items-center gap-2 text-sm", children: [
      ...
      /* @__PURE__ */ jsxs("section", { children: [
        ...
        past.length === 0 ? /* @__PURE__ */ jsx("div", { className: "text-center py-10 rounded-2xl border border-gray-100 bg-white", children: /* @__PURE__ */ jsx("p", { className: "text-gray-400", children: "No past events added yet." }) }) : /* @__PURE__ */ jsx("div", { className: "space-y-4", children: past.map((e) => {
          ...
          return /* @__PURE__ */ jsx("article", { className: "bg-white rounded-2xl border border-gray-100 overflow-hidden opacity-80 hover:opacity-100 transition-opacity", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row", children: [
            e.cover_url && /* @__PURE__ */ jsx("div", { className: "sm:w-36 h-32 sm:h-auto shrink-0 overflow-hidden", children: /* @__PURE__ */ jsx("img", { src: e.cover_url, alt: e.title, className: "w-full h-full object-cover grayscale", loading: "lazy" }) }),

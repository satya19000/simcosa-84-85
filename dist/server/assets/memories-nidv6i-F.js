...
import { l as listMemories, p as postMemory, a as addMemoryImages, d as deleteMemory, b as deleteMemoryImage, r as reorderMemoryImages, t as toggleLike, e as editMemory, c as deleteComment, f as addComment } from "./memories-Dxu0Cu4b.js";
import { u as useAuth, B as Button, a as cn } from "./router-DVvQVXlU.js";
...
import { u as useUploadQueue, D as DropzoneUpload, d as deleteFromFirebaseStorage, c as compressImage, a as uploadToFirebaseStorageResumable } from "./useUploadQueue-C2OT03as.js";
...
function MemoryAttachmentGrid({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mt-4 space-y-2", children: [
    ...
    reordering && docItems.length > 0 && /* @__PURE__ */ jsx("div", { className: "space-y-2", children: docItems.map((img, i) => {
      const origIdx = getOriginalIdx(img);
      return /* @__PURE__ */ jsxs("div", { className: "relative flex items-center gap-3 rounded-xl border border-amber-100 bg-amber-50/40 px-4 py-3", children: [
        attachmentIcon(img.mime_type),

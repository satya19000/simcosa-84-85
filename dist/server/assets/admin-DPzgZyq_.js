...
const adminCreateEvent = createServerFn({
  ...
  await query(`INSERT INTO events (title, description, location, event_date, cover_data, cover_mime, created_by)
       VALUES ($1, $2, $3, $4, $5, $6, $7)`, [title, description || null, location || null, eventDate, coverBytes, coverMime, context.userId]);
  return {
    ok: true
  };
});

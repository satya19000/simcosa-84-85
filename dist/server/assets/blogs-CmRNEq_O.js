...
import { l as listBlogs, c as createBlog } from "./blogs-Bpo-Us72.js";
import { u as useAuth, B as Button, C as CATEGORIES, S as SAMPLE_BLOGS } from "./router-5S2W13XD.js";
...
import { D as DropzoneUpload, c as compressImage, u as uploadToFirebaseStorage } from "./image-compress-Ch56BRgI.js";
import "./createSsrRpc-BzRuGlnF.js";
import "./server-B29Zb1Az.js";
    ...
    /* @__PURE__ */ jsxs("div", { className: "bg-white border-b border-amber-100 px-4 py-10", children: [
      ...
      showForm && /* @__PURE__ */ jsxs("form", { onSubmit: onPublish, className: "mx-auto max-w-6xl mt-6 bg-amber-50 rounded-2xl border border-amber-200 p-5 space-y-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx(DropzoneUpload, { files: coverFiles, onFilesChange: setCoverFiles, accept: "image/*", multiple: false, disabled: posting, className: "mt-1" })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsx(Button, { type: "submit", disabled: posting, className: "bg-amber-500 hover:bg-amber-600 text-white font-bold h-12 px-8 rounded-xl", children: posting ? "Publishing…" : "Publish" }) })
      ] })
    ] }),

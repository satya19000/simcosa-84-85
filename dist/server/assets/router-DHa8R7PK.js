...
const appCss = "/assets/styles-DMCzTciE.css";
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "pointer-events-auto flex items-center gap-3 sm:gap-4 rounded-2xl border border-amber-200 bg-gradient-to-br from-amber-50 via-white to-orange-50 px-5 py-4 sm:px-6 sm:py-5 shadow-xl ring-1 ring-amber-100 max-w-md", children: [
        ...
        /* @__PURE__ */ jsxs("p", { className: "text-base sm:text-lg font-semibold leading-snug text-gray-800", children: [
          "Welcome to ",
...
const $$splitComponentImporter$e = () => import("./auth-BQBqUVYH.js");
...
const $$splitComponentImporter$d = () => import("./about-DnBMPG2G.js");
...
const $$splitComponentImporter$c = () => import("./_authenticated-CjJj0AKC.js");
const Route$c = createFileRoute("/_authenticated")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./index-BvYqd3QV.js");
...
const $$splitComponentImporter$a = () => import("./support-BGRFMk2K.js");
const Route$a = createFileRoute("/_authenticated/support")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$9 = () => import("./profile-CaFi-T_P.js");
const Route$9 = createFileRoute("/_authenticated/profile")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$8 = () => import("./memories-DAS4lPdY.js");
...
const $$splitComponentImporter$7 = () => import("./gallery-fyK-L4D2.js");
...
const $$splitComponentImporter$6 = () => import("./events-O6-X87rE.js");
...
const $$splitComponentImporter$5 = () => import("./donations-CIjUOJ1X.js");
...
const $$splitComponentImporter$4 = () => import("./directory-Bp7bAps_.js");
...
const $$splitComponentImporter$3 = () => import("./blogs-pVXa_kuh.js");
...
const $$splitComponentImporter$2 = () => import("./announcements-D2sxVkPS.js");
...
const $$splitComponentImporter$1 = () => import("./admin-4sqDR8sc.js");
...
const $$splitComponentImporter = () => import("./blogs._id-CubhbCWz.js");
...
const AuthenticatedSupportRoute = Route$a.update({
  id: "/support",
  path: "/support",
  getParentRoute: () => AuthenticatedRoute
});
const AuthenticatedProfileRoute = Route$9.update({
  id: "/profile",
  path: "/profile",
  getParentRoute: () => AuthenticatedRoute
});

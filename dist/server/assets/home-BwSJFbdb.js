...
import { l as listMemories, t as toggleLike } from "./memories-3JGDCUY9.js";
  ...
  return /* @__PURE__ */ jsxs("div", { className: "overflow-x-hidden", children: [
    ...
    /* @__PURE__ */ jsx("section", { className: "py-20 px-4 bg-gradient-to-b from-amber-50 to-orange-50/50", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-4xl", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-5", children: [
        previewMemories.length === 0 && /* @__PURE__ */ jsx("div", { className: "bg-white rounded-2xl p-6 shadow-sm border border-amber-100 text-center text-gray-500", children: !user ? "Please sign in to view and share memories." : !canInteract ? "Admin approval required to view memories." : "No memories shared yet — be the first!" }),

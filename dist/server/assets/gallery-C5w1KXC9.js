import { c as createSsrRpc } from "./router-Dnr0rR3U.js";
...
const replaceGalleryItemFile = createServerFn({
  method: "POST"
}).middleware([requireApproved]).inputValidator((d) => d).handler(createSsrRpc("f434d61b2a8e37bba683c7432002f2d171b189ec353abe879561451f68917796"));

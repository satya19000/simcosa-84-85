...
import { c as createSsrRpc, a as cn, u as useAuth, B as Button } from "./router-BO2f2z9N.js";
import { a as requireAdmin, c as requireOwner } from "./middleware-q9eKmX0S.js";
import { c as createServerFn } from "./server-B57haCpF.js";
import { u as useUploadQueue, D as DropzoneUpload, f as formatFileSize, c as compressImage, a as uploadToFirebaseStorageResumable, d as deleteFromFirebaseStorage } from "./useUploadQueue-C6kKjen4.js";
import { r as replaceGalleryItemFile, u as uploadGalleryItem } from "./gallery-0F_KiX49.js";
import { p as postMemory, a as addMemoryImages } from "./memories-BLcArf2J.js";
...
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-DjughiCF.js";
...
function EventsTab() {
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-3 mb-6", children: [
      ...
      }, className: "h-11", children: "+ Add Upcoming Event" }),
      /* @__PURE__ */ jsx(Button, { variant: "outline", onClick: () => {
        closeModal();
        setMode("add-past");
      }, className: "h-11", children: "+ Add Old / Past Event" })
    ] }),
    !events?.length && /* @__PURE__ */ jsx("p", { className: "text-muted-foreground py-8 text-center", children: "No events yet. Add your first event above." }),
    /* @__PURE__ */ jsx("div", { className: "space-y-3", children: events?.map((e) => {
      ...
      return /* @__PURE__ */ jsxs("div", { className: `rounded-lg border bg-card p-4 flex flex-wrap justify-between gap-3 items-start ${isPublished ? "border-border" : "border-amber-200 bg-amber-50/30"}`, children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-2 shrink-0", children: [
          /* @__PURE__ */ jsx(Button, { variant: "outline", className: "h-9 text-sm", onClick: () => {
            setEditTarget(e);
            setMode("edit");
            setCoverFiles([]);
          }, children: "Edit" }),
          /* @__PURE__ */ jsx(Button, { variant: "outline", className: "h-9 text-sm", onClick: () => togglePublished(e), children: isPublished ? "Unpublish" : "Publish" }),
          /* @__PURE__ */ jsx(Button, { variant: "outline", className: "h-9 text-sm text-destructive hover:text-destructive", onClick: () => del(e.id), children: "Delete" })
        ] })
      ] }, e.id);
    }) })
  ] });

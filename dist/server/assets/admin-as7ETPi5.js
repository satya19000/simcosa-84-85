...
import { c as createSsrRpc } from "./createSsrRpc-IrBgw9lc.js";
import { b as requireAdmin } from "./middleware-YB-48sp0.js";
import { c as createServerFn } from "./server-C6pwe8kY.js";
import { u as uploadGalleryItem } from "./gallery-zKeJOIv9.js";
import { p as postMemory } from "./memories-CjBELQ4X.js";
import { c as cn, u as useAuth, B as Button } from "./router-6woAIMJa.js";
...
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-BcZGW2RB.js";
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "space-y-3", children: data?.map((g) => /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-border bg-card p-4 flex flex-wrap justify-between gap-3 items-center", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
        g.media_type === "image" ? /* @__PURE__ */ jsx("img", { src: `/api/gallery/${g.id}`, alt: g.caption ?? g.title ?? "Photo", className: "h-14 w-14 rounded-lg object-cover shrink-0", loading: "lazy" }) : /* @__PURE__ */ jsx("div", { className: "h-14 w-14 rounded-lg bg-muted flex items-center justify-center text-xs text-muted-foreground shrink-0", children: "Video" }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsxs("p", { className: "font-semibold", children: [

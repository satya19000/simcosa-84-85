...
import { r as requireAuth } from "./middleware-BDyeht23.js";
import { c as createServerFn } from "./server-Da8liZjP.js";
import { u as useAuth, B as Button } from "./router-DHa8R7PK.js";
...
const listEvents = createServerFn({
  method: "GET"
}).middleware([requireAuth]).handler(createSsrRpc("c18367e16cf8f111f4daaa26ad40eed19da06d504fa160ccb8fe783a450c11d4"));
const listMyRsvps = createServerFn({
  method: "GET"
}).middleware([requireAuth]).handler(createSsrRpc("d96623ce34cfb7d798bae7bcefd4660c3ff339c9682e7ca3c56605e28ad2460f"));
const listRsvpCounts = createServerFn({
  method: "GET"
}).middleware([requireAuth]).handler(createSsrRpc("f2448d31d2540ace4ac716a8e887c202de19f3cec36fb06652d3eaff1334e641"));
const setRsvp = createServerFn({
  method: "POST"
}).middleware([requireAuth]).inputValidator((d) => d).handler(createSsrRpc("7b26726927eb218882401f89a9d49cc74e6b3590180db87baaaafff30de3f1a0"));
function Countdown({
  date
}) {

...
import { a as requireAdmin } from "./middleware-mNRpMe5L.js";
import { c as createServerFn } from "./server-voIeAJtn.js";
import { c as cn, u as useAuth, B as Button } from "./router-CRLJBhnZ.js";
...
function AddMembersPanel() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mt-6 rounded-xl border border-border bg-card p-5 space-y-6", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "border-t border-border pt-5", children: [
      ...
      /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground mt-1", children: "Columns: name, email, mobile, city, profession. Existing emails are updated, not duplicated." }),

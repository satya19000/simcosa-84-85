...
import { l as listMemories, p as postMemory, a as addMemoryImages, d as deleteMemory, t as toggleLike, b as deleteMemoryImage, e as editMemory, c as deleteComment, f as addComment } from "./memories-BdMUeLh_.js";
import { u as useAuth, B as Button, a as cn } from "./router-DpQdghYH.js";
...
import { Send, BookOpen, Pencil, Trash2, ImagePlus, Heart, MessageCircle, X } from "lucide-react";
import { format } from "date-fns";
import { toast } from "sonner";
import { I as ImageLightbox } from "./ImageLightbox-Dt94sEvv.js";
import { u as useUploadQueue, D as DropzoneUpload, d as deleteFromFirebaseStorage, c as compressImage, a as uploadToFirebaseStorageResumable } from "./useUploadQueue-D4v0rZd-.js";
...
function MemoryImageGrid({
  ...
  return /* @__PURE__ */ jsx("div", { className: cn("mt-4 grid gap-1.5", gridCols), children: images.map((img, i) => /* @__PURE__ */ jsx("button", { type: "button", onClick: () => onOpen(i), className: "overflow-hidden rounded-lg border border-amber-100 cursor-zoom-in aspect-square", children: /* @__PURE__ */ jsx("img", { src: img.image_url, alt: "Memory photo", loading: "lazy", className: "h-full w-full object-cover hover:scale-[1.05] transition-transform duration-300" }) }, img.id)) });
}
function Memories() {
  const {
    user,
          ...
          return /* @__PURE__ */ jsxs("article", { className: "bg-white rounded-2xl border border-amber-100 shadow-sm overflow-hidden", children: [
            /* @__PURE__ */ jsxs("div", { className: "p-6", children: [
              ...
              editingId === m.id ? /* @__PURE__ */ jsx(EditMemoryPanel, { memory: m, onDone: () => setEditingId(null) }) : /* @__PURE__ */ jsxs(Fragment, { children: [
                ...
                canManage && (addingPhotosId === m.id ? /* @__PURE__ */ jsx(AddPhotosPanel, { memoryId: m.id, onDone: () => setAddingPhotosId(null) }) : /* @__PURE__ */ jsxs("button", { type: "button", onClick: () => setAddingPhotosId(m.id), className: "mt-3 flex items-center gap-1.5 text-sm font-semibold text-amber-600 hover:text-amber-700", children: [

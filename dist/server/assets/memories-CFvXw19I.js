...
import { l as listMemories, p as postMemory, a as addMemoryImages, d as deleteMemory, r as reorderMemoryImages, t as toggleLike, b as deleteMemoryImage, e as editMemory, c as deleteComment, f as addComment } from "./memories-D4If1_Hg.js";
import { u as useAuth, B as Button, a as cn } from "./router-DR3MtwZF.js";
import { I as Input } from "./input-CFIWI4J2.js";
import { L as Label } from "./label-C_YYqbMK.js";
import { T as Textarea } from "./textarea-DLekVJZH.js";
...
import { u as useUploadQueue, D as DropzoneUpload, d as deleteFromFirebaseStorage, c as compressImage, a as uploadToFirebaseStorageResumable } from "./useUploadQueue-vXB0IHuJ.js";
import "./middleware-CclwE45v.js";
import "../server.js";
import "node:crypto";
import "pg";
import "jose";
import "./createMiddleware-BvN2ghIY.js";
import "./server-GIzTbeuV.js";
...
function MemoryImageGrid({
  ...
  if (images.length === 1 && !reordering) {
    return /* @__PURE__ */ jsx("button", { type: "button", onClick: () => onOpen(0), className: "mt-4 block w-full overflow-hidden rounded-xl border border-amber-100 cursor-zoom-in", children: /* @__PURE__ */ jsx("img", { src: images[0].image_url, alt: "Memory photo", loading: "lazy", className: "w-full max-h-96 object-cover hover:scale-[1.02] transition-transform duration-300" }) });
  }
            ...
            /* @__PURE__ */ jsxs("div", { className: "p-6", children: [
              ...
              editingId === m.id ? /* @__PURE__ */ jsx(EditMemoryPanel, { memory: m, onDone: () => setEditingId(null) }) : /* @__PURE__ */ jsxs(Fragment, { children: [
                ...
                /* @__PURE__ */ jsx(MemoryImageGrid, { images: m.images, onOpen: (idx) => setLightbox({
                  memoryId: m.id,
                  index: idx
                }), reordering: reorderingId === m.id, onMove: (idx, dir) => handleMoveImage(m.id, m.images, idx, dir) }),
                ...
                canManage && addingPhotosId === m.id && /* @__PURE__ */ jsx(AddPhotosPanel, { memoryId: m.id, onDone: () => setAddingPhotosId(null) })
              ] })
            ] }),

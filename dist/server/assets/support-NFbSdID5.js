...
import { c as createSsrRpc } from "./createSsrRpc-D-YkFQRG.js";
import { a as requireApproved } from "./middleware-DR5mtKPJ.js";
import { c as createServerFn } from "./server-vr8a0_bb.js";
import { u as useAuth, B as Button } from "./router-DY3jszS3.js";
...
const listMySupport = createServerFn({
  method: "GET"
}).middleware([requireApproved]).handler(createSsrRpc("d9503064a034dc314a876b59e418cce3dd8fc81b5204142f1f4a165035863843"));
const createSupport = createServerFn({
  method: "POST"
}).middleware([requireApproved]).inputValidator((d) => d).handler(createSsrRpc("f582a9077139cf9b573c808336f3561055edd028b40b857ec56af837b4771d0d"));
const categories = [{
  v: "medical",

...
import { l as listBlogs, c as createBlog } from "./blogs-DhuCHN8O.js";
import { u as useAuth, B as Button, C as CATEGORIES, S as SAMPLE_BLOGS } from "./router-CRLJBhnZ.js";
...
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-CdHzctnv.js";
import { PenLine, BookOpen, ArrowRight, Star } from "lucide-react";
import { format } from "date-fns";
import { toast } from "sonner";
import "./createSsrRpc-f0SVIepO.js";
import "./server-voIeAJtn.js";
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gradient-to-b from-amber-50/60 to-white", children: [
    /* @__PURE__ */ jsxs("div", { className: "bg-white border-b border-amber-100 px-4 py-10", children: [
      ...
      showForm && /* @__PURE__ */ jsxs("form", { onSubmit: onPublish, className: "mx-auto max-w-6xl mt-6 bg-amber-50 rounded-2xl border border-amber-200 p-5 space-y-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx(Label, { htmlFor: "image", className: "font-semibold text-gray-700", children: "Cover image (optional)" }),
          /* @__PURE__ */ jsx(Input, { id: "image", name: "image", type: "file", accept: "image/*", className: "h-12 mt-1 border-amber-200 rounded-xl" })
        ] }),

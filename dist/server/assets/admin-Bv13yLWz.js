...
import { c as createSsrRpc, a as cn, u as useAuth, B as Button } from "./router-B0MpVdNo.js";
import { a as requireAdmin } from "./middleware-DsU1FtFu.js";
import { c as createServerFn } from "./server-DuIur6gL.js";
import { u as uploadGalleryItem } from "./gallery-BPGbzMm8.js";
import { p as postMemory } from "./memories-BuWKchV8.js";
import { D as DropzoneUpload, c as compressImage, u as uploadToFirebaseStorage, d as deleteFromFirebaseStorage } from "./image-compress-DXVH7xSp.js";
...
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-DdE313HG.js";
...
function GalleryTab() {
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-border bg-card p-5 mb-6", children: [
      ...
      /* @__PURE__ */ jsx(DropzoneUpload, { files, onFilesChange: setFiles, accept: "image/*,video/*,.pdf,.doc,.docx,.xls,.xlsx,.ppt,.pptx", disabled: uploading }),
      files.length > 0 && /* @__PURE__ */ jsx(Button, { onClick: upload, disabled: uploading, className: "mt-3 h-11", children: uploading ? "Uploading…" : `Upload ${files.length} item(s)` })
    ] }),
    data?.length === 0 && /* @__PURE__ */ jsx("p", { className: "text-muted-foreground", children: "No gallery items yet." }),
    /* @__PURE__ */ jsx("div", { className: "space-y-3", children: data?.map((g) => /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-border bg-card p-4 flex flex-wrap justify-between gap-3 items-center", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
        g.media_type === "image" ? /* @__PURE__ */ jsx("img", { src: g.file_url ?? `/api/gallery/${g.id}`, alt: g.caption ?? g.title ?? "Photo", className: "h-14 w-14 rounded-lg object-cover shrink-0", loading: "lazy" }) : /* @__PURE__ */ jsx("div", { className: "h-14 w-14 rounded-lg bg-muted flex items-center justify-center text-xs text-muted-foreground shrink-0", children: "Video" }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsxs("p", { className: "font-semibold", children: [
...
function MemoriesTab() {
  ...
  const del = async (id) => {
    ...
    try {
      ...
      if (res.fbStoragePath) {
        deleteFromFirebaseStorage(res.fbStoragePath).catch((err) => console.error("[admin/memories] failed to delete storage object:", err));
      }
    } catch (err) {
      toast.error(err instanceof Error ? err.message : "Failed");
    }
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-border bg-card p-5 mb-6 space-y-3", children: [
      ...
      /* @__PURE__ */ jsx(DropzoneUpload, { files, onFilesChange: setFiles, accept: "image/*", multiple: false, disabled: posting }),
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsxs("form", { onSubmit: create, className: "rounded-xl border border-border bg-card p-5 grid sm:grid-cols-2 gap-3", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "sm:col-span-2", children: [
        ...
        /* @__PURE__ */ jsx(DropzoneUpload, { files: coverFiles, onFilesChange: setCoverFiles, accept: "image/*", multiple: false, disabled: creating, className: "mt-1" })
      ] }),
      /* @__PURE__ */ jsx(Button, { type: "submit", disabled: creating, className: "sm:col-span-2 h-11", children: creating ? "Creating…" : "Create event" })
    ] }),

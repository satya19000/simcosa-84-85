...
import { g as getBlog, u as updateBlog, s as setBlogFeatured, a as setBlogPublished, d as deleteBlog, t as toggleBlogLike, b as addBlogComment } from "./blogs-D7iipQez.js";
import { R as Route, u as useAuth, S as SAMPLE_BLOGS, C as CATEGORIES, B as Button } from "./router-DY3jszS3.js";
...
function BlogDetail() {
  ...
  if (sample) {
    return /* @__PURE__ */ jsx("div", { className: "min-h-screen bg-gradient-to-b from-amber-50/60 to-white", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-3xl px-4 sm:px-6 py-8", children: [
      ...
      /* @__PURE__ */ jsx("p", { className: "text-gray-700 leading-relaxed whitespace-pre-line mt-6 text-lg", children: sample.content })
    ] }) });
  }
  if (blog === void 0) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "min-h-screen bg-gradient-to-b from-amber-50/60 to-white", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-3xl px-4 sm:px-6 py-8", children: [
    ...
    ] }) : /* @__PURE__ */ jsx("p", { className: "text-gray-700 leading-relaxed whitespace-pre-line mt-6 text-lg", children: blog.content }),

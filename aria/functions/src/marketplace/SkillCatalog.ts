import type { MarketplaceItemRecord, MarketplaceCategory, MarketplaceItemType, SkillLifecycleStatus } from './MarketplaceTypes'
...
export class SkillCatalog {
  ...
  async browse(filters: CatalogFilters, page = 1, pageSize = 20): Promise<CatalogPage> {
    const status: SkillLifecycleStatus = 'published'
  ...
  async getDetail(itemId: string): Promise<MarketplaceItemRecord | null> {

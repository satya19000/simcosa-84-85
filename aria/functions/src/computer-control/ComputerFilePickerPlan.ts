import type { ComputerActionPlan } from './ComputerTypes'
 ...
 */
export class ComputerFilePickerPlan {
  constructor(private readonly planner: ComputerActionPlanner) {}

  /**
   * Generate a safe file picker + analysis plan.
   * Returns a proposed plan — never auto-executes.
   */
  async generatePlan(options: FilePickerPlanOptions): Promise<ComputerActionPlan> {
    ...
    return this.planner.planFromIntent(
      options.userId,
      options.tenantId,
      intent,
      [

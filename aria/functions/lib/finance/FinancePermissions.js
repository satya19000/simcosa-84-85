...
exports.FinancePermissions = void 0;
const COL = (userId) => `users/${userId}/financePermissions`;
class FinancePermissions {
    ...
    async canAccess(userId, scopeId, minRole = 'reader') {
        ...
        if (!record)
            return false;
        const order = ['reader', 'approver', 'finance_admin', 'admin'];
        return order.indexOf(record.role) >= order.indexOf(minRole);
    }
}
exports.FinancePermissions = FinancePermissions;
//# sourceMappingURL=FinancePermissions.js.map
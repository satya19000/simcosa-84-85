...
exports.ModelCatalogStore = exports.MODEL_CATALOG = void 0;
/**
...
class ModelCatalogStore {
    list() {
        return exports.MODEL_CATALOG;
    }
    byProvider(provider) {
        return exports.MODEL_CATALOG.filter((m) => m.provider === provider);
    }
    byModelId(modelId) {
        return exports.MODEL_CATALOG.find((m) => m.modelId === modelId) ?? null;
    }
    byTaskType(taskType) {
        return exports.MODEL_CATALOG.filter((m) => m.taskTypes.includes(taskType));
    }
}
exports.ModelCatalogStore = ModelCatalogStore;

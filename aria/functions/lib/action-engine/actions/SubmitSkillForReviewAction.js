...
exports.SubmitSkillForReviewAction = void 0;
...
class SubmitSkillForReviewAction {
    constructor() {
        this.toolName = 'submitSkillForReview';
    }
    validate(args) {
    ...
    async execute(args, ctx) {
        try {
            ...
            return (0, ActionResult_1.successResult)(updated.itemId, `Skill "${updated.itemId}" submitted for review.`, data, (0, ActionContext_1.elapsedMs)(ctx));
        }
        catch (err) {
...
exports.SubmitSkillForReviewAction = SubmitSkillForReviewAction;
// Self-register on module load
const ActionRegistry_1 = require("../ActionRegistry");
ActionRegistry_1.registry.register(new SubmitSkillForReviewAction());
//# sourceMappingURL=SubmitSkillForReviewAction.js.map
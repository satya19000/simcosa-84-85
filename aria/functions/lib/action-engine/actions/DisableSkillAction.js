...
exports.DisableSkillAction = void 0;
...
class DisableSkillAction {
    ...
    async execute(args, ctx) {
        try {
            ...
            return (0, ActionResult_1.successResult)(updated.installationId, `Skill installation "${updated.installationId}" disabled.`, data, (0, ActionContext_1.elapsedMs)(ctx));
        }
        catch (err) {
...
exports.DisableSkillAction = DisableSkillAction;
// Self-register on module load
const ActionRegistry_1 = require("../ActionRegistry");
ActionRegistry_1.registry.register(new DisableSkillAction());
//# sourceMappingURL=DisableSkillAction.js.map
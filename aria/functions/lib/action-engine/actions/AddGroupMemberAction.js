...
exports.AddGroupMemberAction = void 0;
...
class AddGroupMemberAction {
    ...
    async execute(args, ctx) {
        try {
            ...
            return (0, ActionResult_1.successResult)(args.groupId, group ? 'Member added to group.' : 'Group not found.', data, (0, ActionContext_1.elapsedMs)(ctx));
        }
        catch (err) {
...
exports.AddGroupMemberAction = AddGroupMemberAction;
// Self-register on module load
const ActionRegistry_1 = require("../ActionRegistry");
ActionRegistry_1.registry.register(new AddGroupMemberAction());
//# sourceMappingURL=AddGroupMemberAction.js.map
...
const createContactTool = {
    name: 'createContact',
    description: 'Saves a new contact or person to the user\'s relationship memory. ' +
...
const updateContactTool = {
    name: 'updateContact',
    description: 'Updates an existing contact\'s details. Requires the contactId. ' +
...
const addRelationshipNoteTool = {
    name: 'addRelationshipNote',
    description: 'Adds a note or memory about a person to their contact record. ' +
...
const searchContactsTool = {
    name: 'searchContacts',
    description: 'Searches the user\'s contacts by name, role, organization, relationship type, or tags. ' +

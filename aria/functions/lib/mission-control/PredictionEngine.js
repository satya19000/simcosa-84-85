...
class PredictionEngine {
    constructor(predictions, missions, tasks, config) {
    ...
    async predictCompletionEta(userId, missionId) {
    ...
    async predictTaskSlippageRisk(userId, missionId) {
        const mission = await this.missions.getMission(userId, missionId);
        if (!mission || !mission.targetDate)
            return null;
    ...
    async refreshAll(userId, mission) {

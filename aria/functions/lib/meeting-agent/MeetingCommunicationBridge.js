...
exports.MeetingCommunicationBridge = void 0;
const uuid_1 = require("uuid");
const MeetingLogger_1 = require("./MeetingLogger");
const FOLLOW_UPS_COL = (tenantId) => `tenants/${tenantId}/meetingFollowUps`;
class MeetingCommunicationBridge {
    constructor(db, approvalBridge) {
        this.db = db;
     ...
     */
    async requestSendApproval(followUp, userId) {
        const actionMap = {
    ...
    async listFollowUps(tenantId, sessionId) {
    ...
    buildEmailDraft(summary, recipientName) {
...
Best regards`;
    ...
    buildWhatsAppDraft(summary, recipientName) {
...
exports.MeetingCommunicationBridge = MeetingCommunicationBridge;
//# sourceMappingURL=MeetingCommunicationBridge.js.map
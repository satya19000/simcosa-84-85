...
// GET /api/memories/image/:id — stream a memory's stored photo to approved members.
export async function serveMemoryImage(request: Request): Promise<Response | null> {

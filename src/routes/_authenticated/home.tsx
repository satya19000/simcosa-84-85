...
import {
  ...
  HelpCircle, Trophy, ArrowRight, Star, PenLine
} from "lucide-react";
    ...
    <div className="overflow-x-hidden">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/directory">
              <Button size="lg" className="bg-amber-500 hover:bg-amber-400 text-gray-900 font-bold h-14 px-8 text-lg rounded-2xl shadow-xl transition-all hover:scale-105">
                <Users className="h-5 w-5 mr-2" /> View Members
              </Button>
            </Link>
            <Link to="/memories">
            ...
            <div className="bg-white rounded-3xl overflow-hidden shadow-md border border-amber-100 hover:shadow-xl hover:-translate-y-1 transition-all">
              <div className="relative h-56">
                ...
                <div className="absolute inset-0 bg-amber-900/40 flex items-center justify-center">
                  <p className="text-white font-display text-xl font-bold text-center px-4">186+ Batchmates Connected</p>
                </div>
              </div>
              <div className="p-6">
                ...
                <Link to="/directory" className="mt-4 flex items-center gap-2 text-amber-600 font-bold text-sm hover:gap-3 transition-all">
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-amber-500 to-orange-500">
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="text-white" style={{ fontFamily: '"Playfair Display", serif' }}>Stay Connected with Your Batchmates</h2>
          <p className="mt-4 text-amber-100 text-lg max-w-xl mx-auto">
            Explore the full members portal — directory, gallery, memories and more.
          </p>
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/directory">
